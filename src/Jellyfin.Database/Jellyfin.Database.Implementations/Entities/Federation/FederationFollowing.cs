...
/// <summary>
/// An entity representing an actor this instance follows.
/// </summary>
public class FederationFollowing
{
    /// <summary>
    /// Initializes a new instance of the <see cref="FederationFollowing"/> class.
    /// </summary>
    /// <param name="actorId">The ID of the actor.</param>
    public FederationFollowing(int actorId)
    {
        ActorId = actorId;
